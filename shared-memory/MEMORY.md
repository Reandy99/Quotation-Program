...
- Whitepaper review priority: Exel should review outputs not only for aesthetics/engagement, but for whether they are optimal for generating new leads and new sales.
- Whitepaper brand guideline (from reference board): tone should be direct, confident, professional, warm, and transparent; visuals should stay clean, premium, minimal, whitespace-heavy, with white/off-white/charcoal/warm neutral palette and a restrained gold accent.
- Whitepaper visual curation rule: avoid low-meaning food/detail shots as main visuals unless they clearly support the story; prioritize photos with people, interaction, audience, stage, branding, venue context; replace weak hero images even if technically fine.
- User-facing ops preference: Agent Dashboard is the live view for task handoffs (To Do/In Progress/Done + activity feed), not logs.
...
[2026-04-20T01:00:00Z] system-healthcheck-daily | Ran openclaw status --deep | Gateway reachable (systemd running); Telegram channel WARN (requireMention=false, groupPolicy open/wildcard allowlist); Security audit: 7 critical | agent_used=main
[2026-04-20T10:45:00Z] security-audit | Ran openclaw security audit --deep | 7 critical (Telegram open groups + wildcard allowFrom; small-model fallback with web/browser; runtime/fs tools exposed); pending: lock down Telegram + adjust model fallbacks/sandbox | agent_used=main
[2026-04-20T18:30:00Z] memory-maintenance-daily | Promoted durable Whitepaper brand/review/collab preferences from daily notes | Updated Operational Preferences (lead/sales review, brand guideline, visual curation, agent-dashboard as handoff view) | agent_used=main
[2026-04-20T19:16:00Z] dream-diary-entry | Wrote dream diary entry from memory fragments (themes: 5da4fd6b, heyreandy-ai-content-daily, reflections, theme, 1.00, kept) | Entry saved to /root/.openclaw/workspace/dream-diary/2026-04-20.md | agent_used=main
[2026-04-20T18:47:30Z] security-hardening | Locked down Telegram group policy (allowlist + requireMention + removed wildcard allowlists, restricted to 514720705) and removed small-model fallback nemotron:free | Security audit now 0 critical | agent_used=main
[2026-04-20T22:35:25Z] cron-timeout-adjust | Updated cron job "Memory Dreaming Promotion" to timeoutSeconds=1200 (20m) by converting it to isolated agentTurn running `openclaw memory promote --apply` | Reduced timeout risk | agent_used=main
[2026-04-20 22:45 UTC] cron | Whitepaper Threads research brief (3-5 angle trending) | Wrote /state/whitepaper/threads-research-brief-latest.md | agent_used=DONI
[2026-04-20T23:55:49Z] repliz-schedule-fix | Normalized Repliz scheduled media URLs to avoid grey previews (http -> https) + corrected schedule types/media | Recreated 22 schedules: replaced `http://43.156.181.204/...` with `https://ocindonesia.my.id/...`, converted 1 multi-image LinkedIn post from type=image to type=album, and fixed 1 LinkedIn schedule that had empty media | agent_used=main
[2026-04-21T00:36:26Z] whitepaper-upload-ui-guardrail | Improved Whitepaper upload UI to reduce “stuck upload” confusion | Added max 50MB note + client-side size check that blocks oversize selections and shows selected total/largest size | agent_used=main
[2026-04-21T00:42:50Z] whitepaper-media-dashboard-auto-update | Fixed Whitepaper Media Dashboard not showing new uploads | Upload server now regenerates /media/whitepaper/index.html after each upload; nginx updated to disable caching for /media/whitepaper/ + index.html (no-store) while keeping long cache for images | agent_used=main
