  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6 md:mb-8">
        <Section title="Overdue" leads={overdue} emptyText="No overdue follow-ups" accent="bg-red-500" company={company} onComplete={handleComplete} onReschedule={handleReschedule} />
        <Section title="Today" leads={today} emptyText="Nothing due today" accent="bg-orange-400" company={company} onComplete={handleComplete} onReschedule={handleReschedule} />
        <Section title="Upcoming" leads={upcoming} emptyText="No upcoming follow-ups" accent="bg-green-500" company={company} onComplete={handleComplete} onReschedule={handleReschedule} />
      </div>
