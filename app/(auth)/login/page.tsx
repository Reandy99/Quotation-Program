          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                disabled={loading}
                className="w-full px-3.5 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:border-transparent transition-shadow disabled:opacity-50"
                style={{
                  borderColor: "var(--border-color)",
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between gap-3">
                ...
                <Link href="/forgot-password" className="text-xs font-medium hover:underline" style={{ color: "var(--text-primary)" }}>
                  Forgot password?
                </Link>
              </div>
              <input
