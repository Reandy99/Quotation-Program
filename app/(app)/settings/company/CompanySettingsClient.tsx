        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardContent className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 space-y-1">
                <Label className="dark:text-gray-300">Google Review Link <span className="text-gray-400 font-normal">(optional)</span></Label>
                <Input {...register("google_review_url")} placeholder="https://g.page/r/..." className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:placeholder-gray-500" disabled={isPending} />
                <p className="text-xs text-gray-500 dark:text-gray-400">Used for automated Google review requests in Follow-ups</p>
              </div>
            </div>
          </CardContent>
        </Card>
